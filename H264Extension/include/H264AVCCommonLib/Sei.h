...
//JVT-W046 }
	...
	//Void setLayerProfileLevelIdc ( UInt uilayer, UInt uiIdc )                      { m_layer_profile_idc                      [uilayer] = uiIdc; }

		Void setLayerProfileLevelIdc ( UInt uilayer, UInt uiIdc )                      { m_layer_profile_level_idc                      [uilayer] = uiIdc; }//JVT-W051
  //JVT-S036 lsj start
...
// BUG_FIX liuhui}
   ...
   //JVT-S036 lsj end
    ...
    //SEI changes update }
		...
		//JVT-W047 wxwan
		UInt getLayerProfileLevelIdc ( UInt uilayer ) const { return m_layer_profile_level_idc[uilayer]; }//JVT-W051
  //JVT-S036 lsj start
